    ...
    <FaqAccordion type="single" collapsible className="w-full space-y-6">
      {data?.data.map((item, index) => (
        ...
        >
          ...
          <AccordionContent className="text-[14px] xs:text-[14px] sm:text-[14px] md:text-xl lg:text-xl xl:text-xl 2xl:text-xl 3xl:text-xl font-jakarta font-medium text-[#667085] max-w-[672px]">
            {item?.answer}
          </AccordionContent>
        </AccordionItem>
      ))}
